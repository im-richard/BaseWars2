...
/*
    ...
    :   bw2_loader_pre              SH      called before library loading starts
    :   bw2_loader_post             SH      called after library loaded
*/
...
function rcore.autoload:Run( )
    ...
    */
    ...
    local fol                   = GM.FolderName .. '/gamemode/engine/'
    local files, folders        = file.Find( fol .. '*', 'LUA' )

    local autoload = fol .. '_autoloader.lua'
