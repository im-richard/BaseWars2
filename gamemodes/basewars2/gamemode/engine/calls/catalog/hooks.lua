...
base.c.hooks =
{
    ...
    [ 'bw2_loader_post' ]                       = { 'bw2.loader.post' },
    [ 'bw2_modules_onloaded' ]                  = { 'bw2.modules.onloaded' },
    [ 'bw2_modules_register' ]                  = { 'bw2.modules.register' },
    [ 'bw2_modules_load_pre' ]                  = { 'bw2.modules.load.pre' },
    [ 'bw2_modules_load_post' ]                 = { 'bw2.modules.load.post' },
    [ 'bw2_modules_storage_struct' ]            = { 'bw2.modules.storage.struct' },
}