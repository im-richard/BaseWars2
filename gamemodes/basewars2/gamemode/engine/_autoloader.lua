...
function rlib.autoload:Run( parent )
    ...
    */
    ...
    mf.released                     = 1677326702
    mf.version                      = { 3, 6, 1, 2 }
    mf.version_bw2                  = { 1, 0, 0, 0 }
    ...
    */
    ...
    {
        [[ title       : ........ ]] .. mf.name .. [[ ]],
        [[ library     : ........ ]] .. ( istable( mf.version ) and string.format( '%i.%i.%i.%i', mf.version[ 'major' ] or mf.version[ 1 ] or 1, mf.version[ 'minor' ] or mf.version[ 2 ] or 0, mf.version[ 'patch' ] or mf.version[ 3 ] or 0, mf.version[ 'micro' ] or mf.version[ 4 ] or 0 ) ) or mf.version .. [[ ]],
        [[ gamemode    : ........ ]] .. ( istable( mf.version_bw2 ) and string.format( '%i.%i.%i.%i', mf.version_bw2[ 'major' ] or mf.version_bw2[ 1 ] or 1, mf.version_bw2[ 'minor' ] or mf.version_bw2[ 2 ] or 0, mf.version_bw2[ 'patch' ] or mf.version_bw2[ 3 ] or 0, mf.version_bw2[ 'micro' ] or mf.version_bw2[ 4 ] or 0 ) ) or mf.version_bw2 .. [[ ]],
    ...
    */
    ...
    {
        [[
Copyright (C) 2023 - ]] .. os.date( '%Y' ) .. [[ :: developed by ]] .. mf.author .. [[

]] .. mf.name .. [[ ( 'BW2 Gamemode' ) is licensed under ]] .. mf.license.type .. [[.
