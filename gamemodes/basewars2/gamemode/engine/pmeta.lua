...
function pmeta:getmoney( bStr, sym )
    ...
    if bStr then
        local symbol    = ( isstring( sym ) and sym ) or ( GAMEMODE.Config and GAMEMODE.Config.currency ) or '$'
...
/*
    ...
    returns ply prestige from any addons having such feature
*/
...
/*
    ...
    returns the percentage until next level.
    bStr param returns string with symbol
