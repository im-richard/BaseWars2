/*
    ...
    USAGE:
        ...
        BLAKE2b         sha.blake2b( msg, key, salt, digest_size_in_bytes )
        BLAKE2s         sha.blake2s( msg, key, salt, digest_size_in_bytes )
        BLAKE2bp        sha.blake2bp( msg, key, salt, digest_size_in_bytes )
        BLAKE2sp        sha.blake2sp( msg, key, salt, digest_size_in_bytes )
        BLAKE2Xb        sha.blake2xb( digest_size_in_bytes, msg, key, salt )
        BLAKE2Xs        sha.blake2xs( digest_size_in_bytes, msg, key, salt )

        BLAKE2b-160     sha.blake2b_160( msg, key, salt )            : BLAKE2b with digest_size_in_bytes = 20
        BLAKE2b-256     sha.blake2b_256( msg, key, salt )            : BLAKE2b with digest_size_in_bytes = 32
        BLAKE2b-384     sha.blake2b_384( msg, key, salt )            : BLAKE2b with digest_size_in_bytes = 48
        BLAKE2b-512     sha.blake2b_512( msg, key, salt )            : BLAKE2b with digest_size_in_bytes = 64 (default size)
        BLAKE2s-128     sha.blake2s_128( msg, key, salt )            : BLAKE2s with digest_size_in_bytes = 16
        BLAKE2s-160     sha.blake2s_160( msg, key, salt )            : BLAKE2s with digest_size_in_bytes = 20
        BLAKE2s-224     sha.blake2s_224( msg, key, salt )            : BLAKE2s with digest_size_in_bytes = 28
        BLAKE2s-256     sha.blake2s_256( msg, key, salt )            : BLAKE2s with digest_size_in_bytes = 32 (default size)

        BLAKE3          sha.blake3( msg, key, digest_size_in_bytes )
